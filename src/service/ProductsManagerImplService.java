 ...
 * 
 */
@WebServiceClient(name = "ProductsManagerImplService", targetNamespace = "http://webservices.sud/", wsdlLocation = "http://localhost:2020/webservices/PoductsManager?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:2020/webservices/PoductsManager?wsdl");
